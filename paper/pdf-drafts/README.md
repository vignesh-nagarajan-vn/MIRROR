...
| `MIRROR_Paper_Draft_v8.pdf` | **Current, submitted to SSRN on August 6, 2026 ([abstract 7245078](https://ssrn.com/abstract=7245078), CC BY-NC-ND, moderation pending).** Restores the v6 two-author title block. The research mentor sits beside the corresponding author with his qualifiers (Research Mentor; Applied AI Researcher, Capital One; PhD in Computer Science, IIT Hyderabad), and the Global Indian Scientists & Technocrats (GIST) 2026 Summer Research Internship affiliation runs on one centered line beneath both author blocks. Body unchanged from v7, still 8 pages. |

**v8 is the current submission version** ([SSRN abstract
